...
recall_y_datamap = [datamap_005['recall_mean'][4], datamap_01['recall_mean'][3], datamap_02['recall_mean'][3]]
...
precision_y_dled = [dled_005['precision_mean'][0], dled_01['precision_mean'][0], dled_02['precision_mean'][0]]
