...
def main():
    ...
    #avg_train_loss, scores, mapping = model.fit(n_epochs = 100, leitner = 1)
    avg_train_loss, confidence = model.fit(n_epochs = 100, datamap = 1)
    scores = datamap_conf(confidence)
    predicted_issues = rank_from_scores(scores, 95)
...
if __name__ == "__main__":
    ...
    final_results.to_csv('/home/pablo/active-learning-pablo/results/test/alc/robustness/datamap_005.csv', index=False)
