...
def main():
    ...
    overall_loss = []
    for i in tqdm(range(4), leave = True): #Add stopping criteria
        ...
        #indexes = badge(embeddings, pred, batch_size)
...
if __name__ == "__main__":
    ...
    final_results.to_csv('/home/pablo/active-learning-pablo/results/test/continual_learning/dark_wo_duplicates2/retrain_3000.csv', index=False)
    with open('/home/pablo/active-learning-pablo/results/test/continual_learning/dark_wo_duplicates2/retrain_3000.json', 'w') as f:
        json.dump(losses, f)
