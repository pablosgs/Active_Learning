...
def main():
    ...
    for i in tqdm(range(5), leave = True): #Add stopping criteria
        ...
        if i >= 1:
            ...
            loss = model.fit(teacher = teacher, n_epochs = 100, dis = 1)
        else:
...
if __name__ == "__main__":
    ...
    final_results.to_csv('/home/pablo/active-learning-pablo/results/test/continual_learning/dark_wo_duplicates2/lwf/opt/lwf_08.csv', index=False)
    with open('/home/pablo/active-learning-pablo/results/test/continual_learning/dark_wo_duplicates2/lwf/opt/lwf_08.json', 'w') as f:
        json.dump(losses, f)
